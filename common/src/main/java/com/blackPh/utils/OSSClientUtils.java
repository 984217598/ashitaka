...
public class OSSClientUtils {
    ...
    // accessKey
    private String accessKeyId = "LTAIvH0byNVu3Vz7";
    private String accessKeySecret = "AEqT4QefQzYbCfet75qa2cCYw0md3S";
    // 空间
    private String bucketName = "blackph";
    // 文件存储目录
