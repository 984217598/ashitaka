...
<div id="main">
    <div>
        ...
        <img src="<%=request.getContextPath()%>/images/content.jpg">
    </div>

    <div id="btn">
        <a
                href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzI2MDU2NjgxNQ==&scene=126&bizpsid=0#wechat_redirect">
            <img src="<%=request.getContextPath()%>/images/follow.png" alt="">
        </a>
        <a href="http://www.xingdijiu.com/">
            <img src="<%=request.getContextPath()%>/images/website.png" alt="">
        </a>
    </div>
</div>
</body>
